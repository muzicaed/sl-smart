...
class ExitData {
  ...
  static let enhanceData = [
    ...
    // Sundbybergs centrum
    "3431": [
      StaticExit(name: "Landsv./Pendeltåg", location: ExitData.pos("59.360748", "17.9709"), trainPosition: 2, changeToLines: ["J35", "L22"]),
      StaticExit(name: "Lysgränd", location: ExitData.pos("59.360748", "17.9709"), trainPosition: 2, changeToLines: []),
      StaticExit(name: "Stationsg.", location: ExitData.pos("59.363126", "17.970453"), trainPosition: 0, changeToLines: []),
      StaticExit(name: "Järnvägsg.", location: ExitData.pos("59.360936", "17.972566"), trainPosition: 2, changeToLines: [])
    ],
    // Solna strand
    "3421": [
    ...
    // Huvudsta
    "3411": [
      StaticExit(name: "Byg.", location: ExitData.pos("59.349821", "17.985942"), trainPosition: 0, changeToLines: []),
    ...
    "3161": [
      ...
      StaticExit(name: "Mariedalsv./Hornsberg", location: ExitData.pos("59.33833", "18.01409"), trainPosition: 0, changeToLines: []),
      StaticExit(name: "Kellgrensg.", location: ExitData.pos("59.33686", "18.01671"), trainPosition: 2, changeToLines: []),
    ...
    "3131": [
      ...
      StaticExit(name: "Hantverkarg.", location: ExitData.pos("59.328724", "18.047276"), trainPosition: 2, changeToLines: []),
    ...
    // Kungsträdgården
    "3031": [
      StaticExit(name: "Arsenalsg.", location: ExitData.pos("59.330678", "18.073851"), trainPosition: 0, changeToLines: []),
      StaticExit(name: "Jakobsg./Regeringsg.", location: ExitData.pos("59.330021", "18.068991"), trainPosition: 1, changeToLines: [])
    ],
    // Akalla
    "3271": [
    ...
    // Husby
    "3261": [
      StaticExit(name: "Bergeng.", location: ExitData.pos("59.408152", "17.928786"), trainPosition: 2, changeToLines: []),
    ...
    "3251": [
      ...
      StaticExit(name: "Danmarksg.", location: ExitData.pos("59.40206", "17.94402"), trainPosition: 2, changeToLines: []),
      StaticExit(name: "Köpenhamnsg.", location: ExitData.pos("59.40366", "17.94216"), trainPosition: 0, changeToLines: [])
    ],
    // Hallonbergen
    "3231": [
    ...
    "1301": [
      ...
      StaticExit(name: "Lyckselev.", location: ExitData.pos("59.3644", "17.86962"), trainPosition: 0, changeToLines: [])
    ],
    // Råcksta
    "1281": [
    ...
    // Blackeberg
    "1271": [
      StaticExit(name: "Vinjettg. (vid Direkten)", location: ExitData.pos("59.348204", "17.883484"), trainPosition: 2, changeToLines: []),
      StaticExit(name: "Vinjettg. (vid 7-Eleven)", location: ExitData.pos("59.348142", "17.883199"), trainPosition: 2, changeToLines: []),
    ...
    // S:t Eriksplan
    "1141": [
      StaticExit(name: "Sankt Eriksg.", location: ExitData.pos("59.341703", "18.037748"), trainPosition: 2, changeToLines: []),
      StaticExit(name: "Rörstrandsg.", location: ExitData.pos("59.339777", "18.036418"), trainPosition: 0, changeToLines: []),
    ...
    "1131": [
      ...
      StaticExit(name: "Karlbergsv.", location: ExitData.pos("59.343142", "18.049904"), trainPosition: 2, changeToLines: []),
      StaticExit(name: "Karlbergsv./Västmannag.", location: ExitData.pos("59.342983", "18.045537"), trainPosition: 0, changeToLines: []),
      StaticExit(name: "Karlbergsv. vid Swedbank", location: ExitData.pos("59.343131", "18.049572"), trainPosition: 2, changeToLines: [])
    ],
    // Rådmansg.
    "1121": [
      StaticExit(name: "Sveav./Rådmansg.", location: ExitData.pos("59.340259", "18.05926"), trainPosition: 2, changeToLines: []),
      ...
      StaticExit(name: "Rehnsg.", location: ExitData.pos("59.342374", "18.057346"), trainPosition: 0, changeToLines: []),
    ],
    // Hötorget
    "1111": [
    ...
    // Medborgarplatsen
    "1511": [
      StaticExit(name: "Folkungag. vid Göta Källare", location: ExitData.pos("59.314257", "18.073019"), trainPosition: 0, changeToLines: []),
      StaticExit(name: "Björns trädgård", location: ExitData.pos("59.315369", "18.073075"), trainPosition: 1, changeToLines: []),
      StaticExit(name: "Folkungag.", location: ExitData.pos("59.314297", "18.073812"), trainPosition: 0, changeToLines: [])
    ],
    // Skanstull
    "1521": [
      StaticExit(name: "Allhelgonag.", location: ExitData.pos("59.309853", "18.075149"), trainPosition: 2, changeToLines: []),
      StaticExit(name: "Ringv./Götg.", location: ExitData.pos("59.308024", "18.076608"), trainPosition: 0, changeToLines: []),
      StaticExit(name: "Ringv.", location: ExitData.pos("59.307844", "18.075739"), trainPosition: 0, changeToLines: []),
      StaticExit(name: "Ringv. vid Forex", location: ExitData.pos("59.307504", "18.0759"), trainPosition: 0, changeToLines: [])
    ],
    // Gullmarsplan
    "1551": [
      StaticExit(name: "Johanneshovsv.", location: ExitData.pos("59.299113", "18.080896"), trainPosition: 0, changeToLines: []),
    ...
    // Hammarbyhöjden
    "1911": [
      StaticExit(name: "Ulricehamnsv.", location: ExitData.pos("59.29499", "18.10648"), trainPosition: 0, changeToLines: []),
    ...
    // Gubbängen
    "1851": [
      StaticExit(name: "Herrhagsv.", location: ExitData.pos("59.264159", "18.082069"), trainPosition: 2, changeToLines: []),
    ...
    "1861": [
      ...
      StaticExit(name: "Russinv.", location: ExitData.pos("59.256229", "18.083754"), trainPosition: 0, changeToLines: [])
    ],
    // Farsta
    "1871": [
    ...
    // Mörby Centrum
    "2301": [
      StaticExit(name: "Golfv.", location: ExitData.pos("59.39826", "18.03594"), trainPosition: 1, changeToLines: []),
    ...
    "2251": [
      ...
      StaticExit(name: "Mörbyskolan Vendev.", location: ExitData.pos("59.392161", "18.041686"), trainPosition: 0, changeToLines: []),
    ...
    "2241": [
      ...
      StaticExit(name: "Gamla v.", location: ExitData.pos("59.379409", "18.038059"), trainPosition: 2, changeToLines: [])
    ],
    // Universitetet
    "2231": [
    ...
    // Tekniska högskolan
    "2221": [
      StaticExit(name: "Danderydsg.", location: ExitData.pos("59.345078", "18.07131"), trainPosition: 0, changeToLines: []),
      ...
      StaticExit(name: "Körsbärsv.", location: ExitData.pos("59.347292", "18.066886"), trainPosition: 2, changeToLines: []),
      StaticExit(name: "Odeng.", location: ExitData.pos("59.34663", "18.065717"), trainPosition: 2, changeToLines: [])
    ],
    // Stadion
    "2211": [
      StaticExit(name: "Grev Tureg.", location: ExitData.pos("59.342667", "18.081316"), trainPosition: 0, changeToLines: []),
      StaticExit(name: "Musikhögskolan", location: ExitData.pos("59.343503", "18.080928"), trainPosition: 0, changeToLines: []),
      StaticExit(name: "Valhallav.", location: ExitData.pos("59.342864", "18.082017"), trainPosition: 0, changeToLines: []),
      StaticExit(name: "Karlav./Nybrog.", location: ExitData.pos("59.339798", "18.081330"), trainPosition: 2, changeToLines: [])
    ],
    // Östermalmstorg
    "2101": [
      StaticExit(name: "Sibylleg.", location: ExitData.pos("59.33621", "18.079934"), trainPosition: 1, changeToLines: []),
      StaticExit(name: "Östermalmstorg/Nybrog.", location: ExitData.pos("59.336418", "18.07884"), trainPosition: 2, changeToLines: []),
      StaticExit(name: "Grev Tureg.", location: ExitData.pos("59.33505", "18.074688"), trainPosition: 2, changeToLines: []),
    ...
    // Mariatorget
    "2511": [
      StaticExit(name: "Torkel Knutssonsg.", location: ExitData.pos("59.317251", "18.057747"), trainPosition: 2, changeToLines: []),
    ...
    // Hornstull
    "2531": [
      StaticExit(name: "Långholmsg./Högalidsg.", location: ExitData.pos("59.315744", "18.034209"), trainPosition: 2, changeToLines: []),
    ...
    "2601": [
      ...
      StaticExit(name: "Liljeholmsv./Tvärbana", location: ExitData.pos("59.310877", "18.024251"), trainPosition: 1, changeToLines: ["L22"]),
    ...
    "2131": [
      ...
      StaticExit(name: "Gasverksv.", location: ExitData.pos("59.35745", "18.102304"), trainPosition: 1, changeToLines: []),
      StaticExit(name: "Artemisg.", location: ExitData.pos("59.35557", "18.09972"), trainPosition: 2, changeToLines: []),
      StaticExit(name: "Jägmästarg.", location: ExitData.pos("59.35479", "18.09809"), trainPosition: 2, changeToLines: [])
    ],
    // Gärdet
    "2121": [
    ...
    "2811": [
      ...
      StaticExit(name: "Svandammsv.", location: ExitData.pos("59.30154", "18.012471"), trainPosition: 1, changeToLines: []),
    ],
    // Telefonplan
    "2821": [
      StaticExit(name: "Telefonplan", location: ExitData.pos("59.298182", "17.996750"), trainPosition: 2, changeToLines: []),
      StaticExit(name: "Mikrofonv.", location: ExitData.pos("59.298073", "17.996947"), trainPosition: 2, changeToLines: [])
    ],
    // Hägerstensåsen
    "2831": [
      StaticExit(name: "Personnev.", location: ExitData.pos("59.294287", "17.976294"), trainPosition: 2, changeToLines: []),
      StaticExit(name: "Hägerstensåsen", location: ExitData.pos("59.295558", "17.979448"), trainPosition: 0, changeToLines: [])
    ],
    // Västertorp
    "2841": [
      StaticExit(name: "Västertorpsv.", location: ExitData.pos("59.29058", "17.96519"), trainPosition: 2, changeToLines: []),
      StaticExit(name: "Störtloppsv.", location: ExitData.pos("59.29215", "17.96854"), trainPosition: 0, changeToLines: [])
    ],
    // Fruängen
    "2851": [
