...
class StyleHelper {
    ...
    func setupCustomStyle() {
        ...
        navAppearance.barTintColor = UIColor(red: 0/255, green: 158/255, blue: 102/255, alpha: 1.0)
        ...
        UITabBarItem.appearance().setTitleTextAttributes(
            [
                NSAttributedString.Key.foregroundColor: UIColor(white: 0.0, alpha: 0.75)
            ], for: UIControl.State())
        ...
        UITabBarItem.appearance().setTitleTextAttributes(
            [
                NSAttributedString.Key.foregroundColor: mainGreen
            ], for: .selected)
