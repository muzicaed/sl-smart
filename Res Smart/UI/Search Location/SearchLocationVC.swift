...
class SearchLocationVC: UITableViewController, UISearchResultsUpdating {
    ...
    override func viewDidLoad() {
        ...
        if isLocationForRealTimeSearch {
            let newBackButton = UIBarButtonItem(
                title: "Real time".localized, style: UIBarButtonItem.Style.plain, target: nil, action: nil)
    ...
    @objc func toggleEditFavourites() {
        ...
        editFavouritebutton.setTitle(title, for: UIControl.State())
    ...
    fileprivate func prepareEditFavouriteButton() {
        ...
        editFavouritebutton.setTitle("Change order".localized, for: UIControl.State())
